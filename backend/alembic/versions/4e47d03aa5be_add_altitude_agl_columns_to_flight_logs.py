...
def upgrade() -> None:
    ...
    op.add_column('flight_logs', sa.Column('max_altitude_agl_feet', sa.Integer(), nullable=True))
    op.add_column('flight_logs', sa.Column('min_altitude_agl_feet', sa.Integer(), nullable=True))
    op.add_column('flight_logs', sa.Column('avg_altitude_agl_feet', sa.Integer(), nullable=True))
