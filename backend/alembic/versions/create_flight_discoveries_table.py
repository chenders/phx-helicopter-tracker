...
def upgrade():
    ...
    op.create_table('flight_discoveries',
        ...
        sa.Column('track_downloaded', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('track_download_attempted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index('idx_flight_discoveries_registration', 'flight_discoveries', ['registration'])
    op.create_index('idx_flight_discoveries_track_downloaded', 'flight_discoveries', ['track_downloaded'])
    op.create_index('idx_flight_discoveries_departure_time', 'flight_discoveries', ['departure_time'])
...
def downgrade():
    ...
    op.drop_index('idx_flight_discoveries_departure_time', table_name='flight_discoveries')
    op.drop_index('idx_flight_discoveries_track_downloaded', table_name='flight_discoveries')
    op.drop_index('idx_flight_discoveries_registration', table_name='flight_discoveries')
