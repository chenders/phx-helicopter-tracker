...
class FR24OfficialAPI:
    ...
    def __init__(self):
        ...
        self.phoenix_pd_aircraft = [
            "N621FB", "N622FB", "N623FB", "N624FB", "N625FB", "N626FB", "N627FB", "N628FB"
        ]
        ...
        self.min_request_interval = 0.5  # Minimum 0.5 seconds between API calls (120 requests/minute)
    ...
    def get_flight_positions_by_bounds(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning("FR24 API rate limit exceeded - returning cached or empty data")
    ...
    def get_flight_positions_by_registrations(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            params = {
                'registrations': ','.join(self.phoenix_pd_aircraft)
            }
            
            logger.info(f"Requesting flights by registrations: {params['registrations']}")
