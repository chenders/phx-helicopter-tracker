                    ...
                    try:
                        ...
                        if details:
                            ...
                            if "aircraft" in details:
                                print(
                                    f"Aircraft data: {json.dumps(details['aircraft'], indent=2, default=str)[:500]}"
                                )
                            ...
                            if "trail" in details:
                                ...
                                if trail:
                                    print(
                                        f"Latest trail point: {json.dumps(trail[-1], indent=2, default=str)}"
                                    )
                                    print(
                                        f"First trail point: {json.dumps(trail[0], indent=2, default=str)}"
                                    )
                        else:
    ...
    try:
        ...
        for flight in flights:
            ...
            if reg and reg.startswith("N"):
                ...
                if (
                    "H" in aircraft_type
                    or "AS" in aircraft_type
                    or "EC" in aircraft_type
                ):
                    helis.append(reg)
        ...
        for flight in flights:
            ...
            if reg and reg in phoenix_pd:
                ...
                if hasattr(flight, "__dict__"):
                    print(
                        f"   Flight dict: {json.dumps(flight.__dict__, indent=2, default=str)[:500]}"
                    )
