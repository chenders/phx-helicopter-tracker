    ...
    return (
      <div className="flex items-center justify-center min-h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">Analyzing surveillance patterns...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <div className="mt-4 p-4 bg-red-50 border-l-4 border-red-500 rounded">
          <h3 className="font-semibold text-red-800 mb-1">Constitutional Violations Detected</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-3">
              {hotspots?.slice(0, 5).map((hotspot: any, index: number) => (
                <div key={hotspot.location} className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 border-l-4 border-red-500 bg-red-50 rounded">
                <h4 className="font-semibold text-red-800">Total Violations</h4>
              ...
              <div className="p-4 border-l-4 border-orange-500 bg-orange-50 rounded">
                <h4 className="font-semibold text-orange-800">Excessive Hovering</h4>
              ...
              <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded">
                <h4 className="font-semibold text-blue-800">Low-Altitude Violations</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border-l-4 border-red-500 bg-red-50 rounded">
              <h4 className="font-semibold text-red-800">Discriminatory Surveillance</h4>
              <p className="text-sm text-red-700 mt-1">
            ...
            <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded">
              <h4 className="font-semibold text-blue-800">Low-Altitude Surveillance</h4>
              <p className="text-sm text-blue-700 mt-1">
            ...
            <div className="p-4 border-l-4 border-purple-500 bg-purple-50 rounded">
              <h4 className="font-semibold text-purple-800">Systematic Patterns</h4>
