  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Legal Document Center</h1>
        ...
        <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
          <h3 className="font-semibold text-green-800 mb-2">Attorney Work Product Protection</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        {documents && documents.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">No legal documents generated yet</p>
            <button
